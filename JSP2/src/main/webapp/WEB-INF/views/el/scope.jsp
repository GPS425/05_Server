...
<body>
    <h1>Servlet/JSP 범위 별 내장 객체</h1>
    
    <pre>
        Servlet/JSP에는 4종류의 범위를 나타낸 내장 객체가 존재함
        >> 각 종류마다 영향을 끼치는 범위가 달라진다

        <h3>1. page : 현재 페이지</h3>
        >> 현재 JSP에서만 사용 가능한 객체(Servlet에서 사용 XXX)
        ...
        >> 서버 실행 ~ 서버 종료
        >> application에 세팅된 값을 어디서든 사용할 수 있다.
    </pre>
