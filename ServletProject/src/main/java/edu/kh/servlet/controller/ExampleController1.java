 ...
 *
 * [Servlet 등록 절차]
 * 1. web.xml에 직접 작성하는 방법(근본)
 * 2. @WebServlet() 어노테이션 이용하는 방법(현 시점에서 추천)
 * 
 */
...
public class ExampleController1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 1) 서버에서 HTML 코드를 만들어서 클라이언트에게 전달 (응답 == response)
		...
		// 응답처리 3 : 출력할 HTML 코드를 만들기(이딴 방식 이용 안해요)
		...
		// 응답처리 4 : 출력 스트림을 이용해 클라이언트에게 HTML 코드 제공(응답)
