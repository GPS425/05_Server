...
// Servlet 관련 코드를 작성하기 위해서는 HttpServlet 클래스 상속받아야함
// 상속받았다고 해서 바로 Servlet으로 등록이 되는 것은 아니다.
// 방법 1. web.xml 작성
// 방법 2. @WebServlet() 어노테이션 사용하기
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 응답화면 만들기
		// >> Java(Servlet)에서 응답하면을 만들기 번거롭고 힘듦.
		// >> JSP가 대신 화면을 만들어달라고 요청함!
		...
		// WEB-INF에 있는 파일들은 클라이언트가 url로 직접 접근할 수 없는 영역,
		// 서블릿을 통해서만 접근 가능
